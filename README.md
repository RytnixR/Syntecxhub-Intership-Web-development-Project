...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Week 1** | **Weather App** | Responsive Google-style weather dashboard with autocomplete search, dynamic themes & chart trends | React, Vite, Recharts, OpenWeather API | [Live Link](https://YOUR-NETLIFY-NAME.netlify.app) | [Code](./weather-app) |
